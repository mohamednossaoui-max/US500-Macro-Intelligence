...
def normalize_input(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # validate_record returns a dataclass. Pandas does not reliably expand
    # dataclass instances with DataFrame.apply(..., result_type="expand")
    # across supported pandas versions. Build the quality table explicitly.
    quality_records = [
        asdict(validate_record(row))
