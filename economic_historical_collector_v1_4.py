...
Economic Intelligence — Phase 1B.4
Historical Collector v1.4 — BLS + DOL + ISM + BEA GDP
...
def main():
    ...
    print("HISTORICAL COLLECTOR v1.4 — BLS + DOL + ISM + BEA")
    print("=" * 72)

    records = BASE_RECORDS + GDP_RECORDS
